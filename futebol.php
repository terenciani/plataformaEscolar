...
<body>
	...
	<div id="conteudo" class="background-white">
		<div class="container">
			<h6 class="navegacao">Você está em: Futebol</h6>
			<div class="row border-gray">
				<h1 class="div-label div-label-margin">Futebol</h1>
				
				<div class="col-md-12">
					<?php
						if(isset($_POST['submit'])){
							$mensagem = $controller->inscrever($_POST, "FUTEBOL");
						}
    				?>
				</div>
				<div class="col-md-6">
				...
				<div class="col-md-6">
					...
					<table class="table table-striped">
						...
						<tbody>
							<?php
								$alunos = $controller->getListaPorEsporte("FUTEBOL");
