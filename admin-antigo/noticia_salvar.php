			...
			<section class="container">
				...
				<div class="thumbnail" id="conteudo">
					...
					<?php
						...
						$chamada    	= $_POST['chamada_noticia'];
						$texto     		= $_POST['texto_noticia'];
						$imagem    		= $_FILES['imagem'];
						$dataarrumada 	= explode('/',$_POST['data-noticia'] );
						...
						if (!empty($imagem["name"])) {
							...
							$sql = mysql_query("INSERT INTO tb_noticia VALUES ('', '$titulo', '$chamada', '$nome_imagem','$texto','$dataOriginal.','$fonte', 1)");
				 
							// Se os dados forem inseridos com sucesso
							if ($sql){
								$msg = "<div class='alert alert-success' role='alert'>
											Cadastro efetuado com sucesso!!!
											<a href='noticia_cadastro.php' class='alert-link'>Adicionar nova (+)</a>
										</div>
										<meta http-equiv='refresh' content='2;URL=noticia_principal.php'>";
								...
								$msg = "<div class='alert alert-danger' role='alert'>
											...
											<a href='noticia_cadastro.php' class='alert-link'>Tentar Novamente</a>
										</div>
