				...
				<div class="thumbnail" id="conteudo">
					...
					<?php					
						...
						if (!empty($imagem["name"])) {
							...
							$sqlPreparada = "INSERT INTO tb_banner(titulo, link, alt, imagem, posicao, data, ativo) VALUES ('$titulo','$link','$alt','$nome_imagem','$posicao','$data',1)";
							...
							if ($sql){
								$msg = "<div class='alert alert-success' role='alert'>
											...
											<a href='banner_cadastro.php' class='alert-link'>Adicionar novo (+)</a>
										</div>
								...
								$msg = "<div class='alert alert-danger' role='alert'>
											...
											<a href='banner_cadastro.php' class='alert-link'>Tentar Novamente</a>
										</div>
										<meta http-equiv='refresh' content='2;URL=banner_principal.php'>";
								echo $msg;
							}
