	...
	<body>
		<div class="container-fluid">
			...
			<section class="container">
				<h1 id="admin">Deletar Equipe</h1>
				<?php					
					$id = $_GET['id'];
	
					//Deletar imagem da pasta
					$sql = mysql_query("SELECT imagem FROM tb_servidor where id_servidor=$id");
					while($resultado = mysql_fetch_array($sql)){
						unlink("../imagens/equipe/".$resultado['imagem']);
					}
	
					// Deletar os dados no banco
					$sql = mysql_query("DELETE FROM tb_servidor WHERE id_servidor='".$id."';"); 
					
					// Se os dados forem deletados com sucesso
					if ($sql){
						$msg = "<div class='alert alert-success' role='alert'>
									Exclusão realizada com sucesso!!!
									<a href='equipe_principal.php' class='alert-link'>Listar todos!</a>
								</div>
						...
						$msg = "<div class='alert alert-danger' role='alert'>
									...
									<a href='equipe_principal.php' class='alert-link'>Tentar Novamente!</a>
								</div>
								<meta http-equiv='refresh' content='5;URL=equipe_principal.php'>";
						echo $msg;
					}
