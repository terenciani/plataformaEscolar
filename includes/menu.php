<div class="menu-gov">
	...
	<div class="contato-escola">
		<div class="container">
			<div class="row">
				<div class="col-sm-9">
					<h4 class="numero-contato"><span class="ddd">+55 67</span> 3314-9014 | eewbds@sed.ms.gov.br </h4>
				</div>
				<div class="col-sm-3">
					<div class="midias midias-escola">
						<ul>
							<li>
								<a href="https://www.facebook.com/eewbs/" target="_new" alt="Facebook" title="Facebook">
									<i class="fa fa-facebook icon-midia" aria-hidden="true"></i>
								</a>
							</li>
							<li>
								<a href="https://www.youtube.com/user/eewbs1993" target="_new" alt="YouTube" title="YouTube">
